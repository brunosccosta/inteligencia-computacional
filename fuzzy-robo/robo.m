...
axis([xi xf yi yf]);
rectangle('Position',[centro_x_robo-raio_robo centro_y_robo-raio_robo 2*raio_robo 2*raio_robo],'Curvature',[1,1],'LineStyle',':','EdgeColor','r');
hold on;
plot(centro_x_robo, centro_y_robo, 'r+');
